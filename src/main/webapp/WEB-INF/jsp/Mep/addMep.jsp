								...
								<div class="tab-pane active" id="tab1">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											...
											<span class="help-block"> Sélectionner la date MEP </span>
										</div>
									</div>
									<div class="form-group">
   			...
   			<!-- END TABLE DS -->
								...
								<div class="tab-pane" id="tab3">
					   			...
					   			<!-- end table of problemes resolus -->
							        ...
							        <!-- FORM INLINE EXAMPLE ANOMALIE RESOLUE -->
										<div  class="row"> 
									        <div class="col-md-1">
									         <a href="" title="ajouter une anomalie résolue" class="btn btn-success btn-outline btn-circle"  ng-click="addFormAnomalieResolueAction()" ><i class="fa fa-plus"></i></a>
									        </div>
					   		...
					   		<!-- table of problemes ouvert -->
							        ...
							        <!-- FORM INLINE EXAMPLE ANOMALIE RESOLUE -->
								        <div  class="row"> 
									        <div class="col-md-1">
									         <a href="" title="ajouter une anomalie résolue" class="btn btn-success btn-outline btn-circle"  ng-click="addFormAnomalieOuverteAction()" ><i class="fa fa-plus"></i></a>
									        </div>
