		...
		<nav class="navbar" role="navigation">
			<div class="container-fluid">
				<div class="havbar-header">
					<!-- BEGIN LOGO -->
					<a style="background-color: white; margin-left: 2px" id="index" class="navbar-brand"
						ng-click="showHomeAction()"> <img src="images/logo_sqli.png" alt="Logo">
					</a>
					<!-- END LOGO -->
					...
					<div class="topbar-actions">
						...
						<div class="btn-group-img btn-group">
							...
							<ul class="dropdown-menu-v2" role="menu">
								...
								<li><a href="" ng-click="showHomeAction()"> <i
										class="icon-home" ></i> Page d'acceuil 
								</a></li>
								<!-- 
